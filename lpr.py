...
for tour in contours:
	...
	if len(contours) == 1:
		...
		print msc
		print rc
	elif abs((rc[2]/rc[3])-22/7)<2.4 and rc[2]*rc[3]>max(1000,dst.shape[0]*dst.shape[1]/500):
		print msc
		print rc
...
if len(rectangle)== 1:
	ar = rectangle[0]
	temp = img[ar[1]-3:(ar[1]+ar[3]+2),ar[0]-3:(ar[0]+ar[2]+3)+2]
